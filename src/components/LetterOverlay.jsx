...
const LetterOverlay = ({ onComplete }) => {
  ...
  return (
    ...
    >
      <div 
        ref={contentRef}
        className="bg-white max-w-lg w-full p-8 md:p-12 rounded-2xl shadow-2xl relative border-4 border-pink-100"
      >
        ...
        <div className="mt-6 space-y-4 font-hand text-xl md:text-2xl text-gray-700 leading-relaxed text-center">
