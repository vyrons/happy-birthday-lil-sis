...
const MainContent = ({ isPlaying, toggleMusic }) => {
  ...
  return (
    <div ref={mainRef} className="relative min-h-screen pb-20 bg-pink-50 transition-colors">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center p-8 text-center relative z-10">
        <h2 className="hero-text text-2xl md:text-2xl font-hand text-rose-500 font-bold mb-4 drop-shadow-sm">It's Your Special Day!</h2>
        <h1 className="hero-text text-5xl md:text-6xl font-bold text-rose-600 mb-6 font-hand drop-shadow-md">Happy Birthday, <br/> Little Sister!</h1>
      ...
      {/* Memory Lane */}
      <section className="py-20 px-6 max-w-3xl mx-auto space-y-20 relative z-10">
      ...
      {/* Message Section */}
      <section className="py-20 px-6 text-center max-w-xl mx-auto relative z-10">
      ...
      <section ref={darkSectionRef} className="py-40 px-6 bg-transparent text-center relative z-10">
        <div className="space-y-8">
            <h2 className="text-5xl md:text-6xl font-hand font-bold text-transparent bg-clip-text bg-gradient-to-r from-rose-300 to-pink-300 mb-4 drop-shadow-[0_0_25px_rgba(236,72,153,0.6)]">
